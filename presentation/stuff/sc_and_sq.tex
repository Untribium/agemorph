...
\definecolor{dandelion}{rgb}{1.0,0.60,0.50}
...
\begin{tikzpicture}[scale=4, line/.style={>=latex}] 
	...
	% v8
	\draw[->, line, color=dandelion, very thick, densely dashed] (p00) -- (p08);

	% v4
	\draw[->, line, color=teal, very thick, densely dashed] (p00) -- (p04);
	\draw[->, line, color=teal, very thick, densely dashed] (p04) -- (p08);

	% v2
	\draw[->, line, color=violet, very thick, densely dashed] (p00) -- (p02);
	\draw[->, line, color=violet, very thick, densely dashed] (p02) -- (p04);
	...
	\draw[->, line, color=black, very thick] (p06) -- (p07);
