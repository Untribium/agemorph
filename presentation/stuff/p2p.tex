...
\begin{tikzpicture}[scale=0.36, line/.style={>=latex}, every node/.style={scale=0.36}, y=-1cm] 
	...
	\node [] at (7, 25.75) {\Large Generator};

	\draw[->] (11, 30) -- (13, 30);
	
	\pic{text={13}		{28.5}	{$\hat y$}	{0}	{}};
	\pic{text={14}		{28.5}	{$x\vphantom{xyt}$}	{0}	{}};
	
	\draw[->] (15, 30) -- (17, 28);
	
	\pic{text={13}		{22.5}	{$y\vphantom{xyt}$}	{0}	{}};
	\pic{text={14}		{22.5}	{$x\vphantom{xyt}$}	{0}	{}};
	
	\draw[->] (15, 24) -- (17, 26);
    	
	\node [rotate=90] at (16, 27) {\Large alternating};

	\node[trap, trapezium angle=155] at (19, 27) {\Large Critic};
	
	\draw[->] (21, 27) -- (23, 27);
	
	\pic{text={23}		{25.5}	{\Large $D(x, y)$}	{90}	{}};
