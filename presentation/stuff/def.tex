...
\begin{tikzpicture}[scale=0.36, line/.style={>=latex}, every node/.style={scale=0.36}, y=-1cm] 
	...
	\node [] at (9, 25.75) {\Large Generator};

	\draw[->] (11, 30) -- (12, 30);
	
	\pic{text={12}		{28.5}	{$\Phi\vphantom{xyt}$}	{0}	{}};

	\draw[->] (13, 30) -- (14, 30);

	\pic{text={14}		{28.5}	{$\circ\vphantom{xyt}$}	{0}	{}};
	%\pic{text={15}		{24.5}	{$x\vphantom{xyt}$}	{0}	{}};
	
	%\draw[->] (15.5, 27.5) -- (15.5, 28.5);
	\draw[->] (15, 30) -- (17, 30);
	
	\draw[->] (2, 30) -- (2, 34) -- (14.5, 34) -- (14.5, 31.5);
	
	\pic{text={17}		{28.5}	{$\hat y$}	{0}	{}};
	\pic{text={18}		{28.5}	{$x\vphantom{xyt}$}	{0}	{}};
	
	\draw[->] (19, 30) -- (21, 28);
	
	\pic{text={17}		{22.5}	{$y\vphantom{xyt}$}	{0}	{}};
	\pic{text={18}		{22.5}	{$x\vphantom{xyt}$}	{0}	{}};
	
	\draw[->] (19, 24) -- (21, 26);
    	
	\node [rotate=90] at (20, 27) {\Large alternating};

	\node[trap, trapezium angle=155] at (23, 27) {\Large Critic};
	
	\draw[->] (25, 27) -- (27, 27);
	
	\pic{text={27}		{25.5}	{\Large $D(x, y)$}	{90}	{}};
